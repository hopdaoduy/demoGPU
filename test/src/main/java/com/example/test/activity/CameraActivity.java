...
import com.example.test.camera.Camera2Loader;
import com.example.test.camera.CameraLoader;
import com.example.test.util.FileUtils;
import com.example.test.util.GPUImageFilterTools;
...
public class CameraActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        mImageView  = findViewById(R.id.renderImageView);
    ...
    private void initCamera() {
        mCameraLoader = new Camera2Loader(this, new Camera2Loader.Listener() {
            @Override
            public void sendByte(Bitmap bitmap) throws InterruptedException {
              //  mImageView.setImageBitmap(bitmap);
              //  mImageView.setImageBitmap(mGPUImageView.capture());
            }
        });
        mCameraLoader.setOnPreviewFrameListener(new CameraLoader.OnPreviewFrameListener() {
            ...
            public void onPreviewFrame(byte[] data, int width, int height) {
                ...
                //
               // Camera.Size size = camera.getParameters().getPreviewSize();//Gets the size of the preview image settings
